...
const videos = [
    ...
    {
        src: robot_two_hands_pointing_bottom_left,
        message: "I promise, there's more cool stuff below 😤",
    },
    {
        src: robot_rotating,
        message:
            "I spin when I’m nervous… and you’re making me VERY nervous 😣😵‍💫",
    },
    { src: robot_standing, message: "OK, let's stare at each other 😐" },
    { src: robot_out, message: "FINE YOU WIN, Bye Weirdo 😶‍🌫️" },
    {
        src: robot_peaking,
        message: "You are still here ? 🤯 I have a girlfriend OK 🙅",
    },
    {
        src: robot_standing,
        message: "Fine, send me a message. I will talk to you 🥲",
    },
...
const RobotCarousel = () => {
    ...
    return (
        <div className="sm:pr-6 md:pr-16 absolute sm:top-56 md:bottom-10 md:w-full md:flex sm:justify-end md:justify-end md:items-end">
            ...
            <div
                className={`sm:ml-4 sm:p-4 md:bottom-[130px] md:p-4 sm:text-lg md:text-lg text-center bg-emerald-600 ${
                    isBigScreen
