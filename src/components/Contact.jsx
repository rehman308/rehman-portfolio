  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        'service_dzpx7ae',
        'template_n851a7o',
        { from_name: form.name, to_name: 'Abdul Rehman', from_email: form.email, to_email: 'rehman308@gmail.com', message: form.message },
        'gPV6iMWUYcoMt7yQ4',
      )
      .then(() => {
        setLoading(false);
  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col'>
        ...
        >
          <p className='sm:text-[18px] md:text-[24px] text-emerald-500 uppercase tracking-widest'>Get in touch</p>
          <h2 className='md:text-[60px] sm:text-[50px] text-emerald-200 tracking-widest border-b-[3px] border-emerald-500'>Contact Me</h2>
        </motion.div>
          ...
          >
            ...
            >
              <InputField
                ...
                type='text'
              />
              {nameError && <span className='md:ml-2 text-red-600 tracking-widest'>{nameError}</span>}
              ...
              <InputField
                ...
                type='email'
              />
              {emailError && <span className='md:ml-2 text-red-600 tracking-widest'>{emailError}</span>}
              ...
              <InputField
                ...
                type='text'
              />
              {messageError && <span className='md:ml-2 text-red-600 tracking-widest'>{messageError}</span>}
              ...
              {confirmation && <p className='text-green-300'>{confirmation}</p>}
            </form>
          </motion.div>
