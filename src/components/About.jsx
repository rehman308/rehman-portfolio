    ...
    <Tilt className="w-32">
        ...
        <motion.div
            ...
            className={`p-4 w-full bg-emerald-400/40 border-emerald-500 border-[3px] rounded-[15px] ${
                isSmallScreen && animateSmall
                    ? "sm:animate-heartBeat"
                    : "animate-jello"
        ...
        <section
            ...
            <motion.div
                ...
                <p
                    ...
                    using the MERN Stack with few months of experience. I am
                    skilled in HTML, CSS, JavaScript, Python, Node, Express,
                    REST APIs, Framer Motion and databases like MongoDB/MySQL. I
                    am proficient in version control with Git and have
                    experience deploying applications on platforms like
                    Heroku/AWS. I focus on writing clean, efficient code and
                    collaborating effectively in team environments. I am eager
                    to grow within a dynamic organization, contributing to
                    impactful software solutions and continuously expand my
                ...
                {isBigScreen && (
                    <video
                        ...
                        loop
                        muted
                        className="w-[400px] place-self-center border-[2px] border-emerald-500 rounded-2xl">
                        <source
                ...
                {isSmallScreen && (
                    <video
                        ...
                        loop
                        muted
                        className="mt-3 w-[400px] place-self-center border-[2px] border-emerald-500 rounded-2xl">
                        <source
                            src={robot_two_hands_pointing_top_left}
                            type="video/mp4"
                        />
                        Your browser does not support the video.
                    </video>
            ...
            <motion.div
                ...
                whileInView="show"
                viewport={{ once: true }}
                variants={slideInFromBottom}></motion.div>
