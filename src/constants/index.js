...
export const projects = [
...

    {
        ...
        description:
            "a Hospital System implemented using C++, SQL and Windows Forms for GUI",
        tags: [
            {
                name: "C++",
                color: "bg-[#00599C]",
    ...
    },
    {
        name: "Web Browser",
        description:
            "Web browser written using Python with Qt Framework with multimedia support",
        tags: [
            {
                name: "Python",
                color: "bg-[#3776AB]",
    ...
    },
    {
        name: "Ping Pong",
        description:
            "A classic Pong game implemented in assembly language for the x8086 processor",
        tags: [
            {
                name: "Assembly",
                color: "bg-[#5C6BC0]",
